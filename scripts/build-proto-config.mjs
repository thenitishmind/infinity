...
export const serviceNameMap = {
	account: "infinity.AccountService",
	browser: "infinity.BrowserService",
	checkpoints: "infinity.CheckpointsService",
	file: "infinity.FileService",
	mcp: "infinity.McpService",
	state: "infinity.StateService",
	task: "infinity.TaskService",
	web: "infinity.WebService",
	models: "infinity.ModelsService",
	slash: "infinity.SlashService",
	ui: "infinity.UiService",
