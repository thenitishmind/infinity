...
const createRule = ESLintUtils.RuleCreator((name) => `https://infinity.bot/eslint-rules/${name}`)
...
module.exports = createRule({
	...
	meta: {
		...
		docs: {
			description:
				"Disallow direct VSCode API usage in favor of Infinity's abstraction layers, except in src/hosts/vscode and standalone/runtime-files directories",
			recommended: "error",
		},
		messages: {
			useGrpcClient:
