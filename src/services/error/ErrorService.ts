...
import { InfinityError } from "./InfinityError"
...
export class ErrorService {
	...
	static logException(error: Error | InfinityError): void {
	...
	static toClineError(rawError: any, modelId?: string, providerId?: string): InfinityError {
		return InfinityError.transform(rawError, modelId, providerId)
	}
}
