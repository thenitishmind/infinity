...
log("Running standalone infinity ", VERSION)

const INFINITY_DIR = process.env.INFINITY_DIR || `${os.homedir()}/.infinity`
const DATA_DIR = path.join(INFINITY_DIR, "data")
mkdirSync(DATA_DIR, { recursive: true })
log("Using settings dir:", DATA_DIR)

const EXTENSION_DIR = path.join(INFINITY_DIR, "core", VERSION, "extension")
const EXTENSION_MODE = process.env.IS_DEV === "true" ? ExtensionMode.Development : ExtensionMode.Production

const extension: Extension<void> = {
	id: "saoudrizwan.infinity-dev",
	isActive: true,
...
const extensionContext: ExtensionContext = {
	...
	storagePath: DATA_DIR, // Deprecated, not used in infinity.
	globalStorageUri: URI.file(DATA_DIR),
	globalStoragePath: DATA_DIR, // Deprecated, not used in infinity.

	logUri: URI.file(DATA_DIR),
	logPath: DATA_DIR, // Deprecated, not used in infinity.

	extensionUri: URI.file(EXTENSION_DIR),
	extensionPath: EXTENSION_DIR, // Deprecated, not used in infinity.
