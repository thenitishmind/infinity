 ...
 * GitOperations Class
 *
 * Handles git-specific operations for Infinity's Checkpoints system.
 *
...
export class GitOperations {
	...
	public async initShadowGit(gitPath: string, cwd: string, taskId: string): Promise<string> {
		...
		await git.addConfig("user.name", "Infinity Checkpoint")
		await git.addConfig("user.email", "checkpoint@infinity.bot")
