...
import { ClineRulesToggles as AppClineRulesToggles } from "@shared/infinity-rules"

/**
 * Toggles a Infinity rule (enable or disable)
 * @param controller The controller instance
 * @param request The toggle request
 * @returns The updated Infinity rule toggles
 */
