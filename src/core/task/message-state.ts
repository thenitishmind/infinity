...
export class MessageStateHandler {
	...
	async saveClineMessagesAndUpdateHistory(): Promise<void> {
		try {
			...
			console.error("Failed to save infinity messages:", error)
		}
	}
	...
	async addToClineMessages(message: ClineMessage) {
		// these values allow us to reconstruct the conversation history at the time this infinity message was created
		// it's important that apiConversationHistory is initialized before we add infinity messages
