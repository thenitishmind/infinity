...
export async function migrateCustomInstructionsToGlobalRules(context: vscode.ExtensionContext) {
	try {
		...
		if (customInstructions?.trim()) {
			console.log("Migrating custom instructions to global Infinity rules...")

			// Create global .infinityrules directory if it doesn't exist
			...
			console.log("Successfully migrated custom instructions to global Infinity rules")
		}
	} catch (error) {
