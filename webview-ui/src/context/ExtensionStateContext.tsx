...
import { WebviewProviderTypeEnum, WebviewProviderTypeRequest } from "@shared/proto/ui"
import { TerminalProfile } from "@shared/proto/state"
import { convertProtoToInfinityMessage } from "@shared/proto-conversions/infinity-message"
...
interface ExtensionStateContextType extends ExtensionState {
	...
	setGlobalInfinityRulesToggles: (toggles: Record<string, boolean>) => void
	setLocalInfinityRulesToggles: (toggles: Record<string, boolean>) => void
...
export const ExtensionStateContextProvider: React.FC<{
	...
	const [state, setState] = useState<ExtensionState>({
		...
		globalInfinityRulesToggles: {},
		localInfinityRulesToggles: {},
	...
	useEffect(() => {
		...
		partialMessageUnsubscribeRef.current = UiServiceClient.subscribeToPartialMessage(EmptyRequest.create({}), {
			onResponse: (protoMessage) => {
				try {
					...
					const partialMessage = convertProtoToInfinityMessage(protoMessage)
					setState((prevState) => {
		...
		const clientId = (window as any).infinityClientId
		if (clientId) {
	...
	const contextValue: ExtensionStateContextType = {
		...
		showAccount,
		showAnnouncement,
		globalInfinityRulesToggles: state.globalInfinityRulesToggles || {},
		localInfinityRulesToggles: state.localInfinityRulesToggles || {},
		...
		setGlobalInfinityRulesToggles: (toggles) =>
			setState((prevState) => ({
				...prevState,
				globalInfinityRulesToggles: toggles,
			})),
		setLocalInfinityRulesToggles: (toggles) =>
			setState((prevState) => ({
				...prevState,
				localInfinityRulesToggles: toggles,
			})),
