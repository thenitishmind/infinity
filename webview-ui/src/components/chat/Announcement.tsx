...
const Announcement = ({ version, hideAnnouncement }: AnnouncementProps) => {
	...
	return (
		<div style={containerStyle}>
			...
			<ul style={ulStyle}>
				<li>
					<b>Optimized for Claude 4:</b> Infinity is now optimized to work with the Claude 4 family of models, resulting in
				...
				<li>
					<b>WebFetch Tool:</b> Gemini 2.5 Pro and Claude 4 models now support the WebFetch tool, allowing Infinity to
					retrieve and summarize web content directly in conversations.
				</li>
				<li>
					<b>Self Knowledge:</b> When using frontier models, Infinity is self-aware about his capabilities and featureset.
				</li>
				<li>
			...
			<p style={linkContainerStyle}>
				Join us on{" "}
				<VSCodeLink style={linkStyle} href="https://x.com/infinity">
					X,
				</VSCodeLink>{" "}
				<VSCodeLink style={linkStyle} href="https://discord.gg/infinity">
					discord,
				</VSCodeLink>{" "}
				or{" "}
				<VSCodeLink style={linkStyle} href="https://www.reddit.com/r/infinity/">
					r/infinity
				</VSCodeLink>
				for more updates!
			</p>
