...
import ClineRulesToggleModal from "../infinity-rules/ClineRulesToggleModal"
			...
			<div>
				...
				<ControlsContainer>
					...
					<Tooltip
						...
						tipText={`In ${shownTooltipMode === "act" ? "Act" : "Plan"}  mode, Infinity will ${shownTooltipMode === "act" ? "complete the task immediately" : "gather information to architect a plan"}`}
