			...
			switch (type) {
				...
				case "mistake_limit_reached":
					return [
						...
						<span style={{ color: errorColor, fontWeight: "bold" }}>Infinity is having trouble...</span>,
					]
				...
				case "command":
					return [
						...
						<span style={{ color: normalColor, fontWeight: "bold" }}>Infinity wants to execute this command:</span>,
					]
				case "use_mcp_server":
					...
					return [
						...
						<span
							...
							Infinity wants to {mcpServerUse.type === "use_mcp_tool" ? "use a tool" : "access a resource"} on the{" "}
				...
				case "followup":
					return [
						...
						<span style={{ color: normalColor, fontWeight: "bold" }}>Infinity has a question:</span>,
					]
				default:
					return [null, null]
			}
					...
					return (
						<>
							<div style={headerStyle}>
								...
								<span style={{ fontWeight: "bold" }}>Infinity wants to edit this file:</span>
							</div>
							<CodeAccordian
					...
					return (
						<>
							<div style={headerStyle}>
								...
								{tool.operationIsLocatedInWorkspace === false &&
									toolIcon("sign-out", "yellow", -90, "This file is outside of your workspace")}
								<span style={{ fontWeight: "bold" }}>Infinity wants to create a new file:</span>
							</div>
							<CodeAccordian
								isLoading={message.partial}
								code={tool.content!}
						...
						<>
							<div style={headerStyle}>
								...
								<span style={{ fontWeight: "bold" }}>
									{/* {message.type === "ask" ? "" : "Infinity read this file:"} */}
									Infinity wants to read this file:
								</span>
							</div>
							<div
								style={{
					...
					return (
						<>
							<div style={headerStyle}>
								...
								<span style={{ fontWeight: "bold" }}>
									{message.type === "ask"
										? "Infinity wants to view the top level files in this directory:"
										: "Infinity viewed the top level files in this directory:"}
								</span>
							</div>
							<CodeAccordian
								code={tool.content!}
					...
					return (
						<>
							<div style={headerStyle}>
								...
								<span style={{ fontWeight: "bold" }}>
									{message.type === "ask"
										? "Infinity wants to recursively view all files in this directory:"
										: "Infinity recursively viewed all files in this directory:"}
								</span>
							</div>
							<CodeAccordian
								code={tool.content!}
					...
					return (
						<>
							<div style={headerStyle}>
								...
								<span style={{ fontWeight: "bold" }}>
									{message.type === "ask"
										? "Infinity wants to view source code definition names used in this directory:"
										: "Infinity viewed source code definition names used in this directory:"}
								</span>
							</div>
							<CodeAccordian
								code={tool.content!}
						...
						<>
							<div style={headerStyle}>
								...
								{tool.operationIsLocatedInWorkspace === false &&
									toolIcon("sign-out", "yellow", -90, "This is outside of your workspace")}
								<span style={{ fontWeight: "bold" }}>
									Infinity wants to search this directory for <code>{tool.regex}</code>:
								</span>
							</div>
							<CodeAccordian
								code={tool.content!}
					...
					return (
						<>
							<div style={headerStyle}>
								...
								<span style={{ fontWeight: "bold" }}>
									{message.type === "ask"
										? "Infinity wants to fetch content from this URL:"
										: "Infinity fetched content from this URL:"}
								</span>
							</div>
							<div
								style={{
		...
		switch (message.type) {
			case "say":
				switch (message.say) {
					...
					case "infinityignore_error":
						return <ErrorRow message={message} errorType="infinityignore_error" />
							...
							<>
								<div
									...
									<div style={{ color: "var(--vscode-foreground)", opacity: 0.8 }}>
										Infinity may have trouble viewing the command's output. Please update VSCode (
										<code>CMD/CTRL + Shift + P</code> → "Update") and make sure you're using a supported
										shell: zsh, bash, fish, or PowerShell (<code>CMD/CTRL + Shift + P</code> → "Terminal:
										Select Default Profile").{" "}
										<a
											href="https://github.com/infinity/infinity/wiki/Troubleshooting-%E2%80%90-Shell-Integration-Unavailable"
											style={{
												color: "inherit",
												textDecoration: "underline",
											}}>
							...
							<>
								<div style={headerStyle}>
									...
									<span style={{ color: normalColor, fontWeight: "bold" }}>
										Infinity wants to start a new task:
									</span>
								</div>
						...
						return (
							<>
								<div style={headerStyle}>
									...
									<span style={{ color: normalColor, fontWeight: "bold" }}>
										Infinity wants to condense your conversation:
									</span>
								</div>
								<NewTaskPreview context={message.text || ""} />
							</>
						...
						return (
							<>
								<div style={headerStyle}>
									...
									<span style={{ color: normalColor, fontWeight: "bold" }}>
										Infinity wants to create a Github issue:
									</span>
								</div>
