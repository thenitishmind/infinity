...
import { UsageTransaction, PaymentTransaction } from "@shared/InfinityAccount"
			...
			{user ? (
				...
				<div className="flex flex-col items-center pr-3">
					...
					<VSCodeButton onClick={handleLogin} className="w-full mb-4">
						Sign up with Infinity
					</VSCodeButton>

					<p className="text-[var(--vscode-descriptionForeground)] text-xs text-center m-0">
						By continuing, you agree to the <VSCodeLink href="https://infinity.bot/tos">Terms of Service</VSCodeLink> and{" "}
						<VSCodeLink href="https://infinity.bot/privacy">Privacy Policy.</VSCodeLink>
					</p>
				</div>
			)}
		</div>
