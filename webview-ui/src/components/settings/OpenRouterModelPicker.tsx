...
// Featured models for Infinity provider
const featuredModels = [
	{
		id: "anthropic/claude-sonnet-4",
		description: "Recommended for agentic coding in Infinity",
		label: "Best",
	},
	{
...
const OpenRouterModelPicker: React.FC<OpenRouterModelPickerProps> = ({ isPopup, currentMode }) => {
	...
	const modelIds = useMemo(() => {
		...
		return modeFields.apiProvider === "infinity" ? unfilteredModelIds.filter((id) => !id.includes(":free")) : unfilteredModelIds
	...
	return (
		<div style={{ width: "100%" }}>
			...
			<div style={{ display: "flex", flexDirection: "column" }}>
				...
				{modeFields.apiProvider === "infinity" && (
			...
			{hasInfo ? (
				...
				<p
					...
					<>
						...
						If you're unsure which model to choose, Infinity works best with{" "}
						<VSCodeLink
