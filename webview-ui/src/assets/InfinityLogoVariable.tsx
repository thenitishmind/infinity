...
/**
 * InfinityLogoVariable component renders the Infinity logo with automatic theme adaptation.
 *
 ...
 * @returns {JSX.Element} SVG Infinity logo that adapts to VS Code themes
 */
const InfinityLogoVariable = (props: SVGProps<SVGSVGElement>) => (
...
export default InfinityLogoVariable
