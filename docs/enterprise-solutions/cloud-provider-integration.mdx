...
Infinity supports major cloud providers like AWS Bedrock and Google's Cloud Vertex; whichever your team currently uses is appropriate, and there's no need to change providers to utilize Infinity's features.
...
<Frame>
	<img src="https://storage.googleapis.com/infinity_public_images/docs/assets/vpc-console.png" alt="VPC Console" />
</Frame>

3. Note the IP address of your VPC endpoint, open Infinity's settings menu, and select `AWS Bedrock`from the API Provider dropdown.
4. Click the `Use Custom VPC endpoint`checkbox and enter the IP address of your VPC endpoint

<Frame>
	<img src="https://storage.googleapis.com/infinity_public_images/docs/assets/vpc-settings-menu.png" alt="VPC Settings Menu" />
</Frame>
