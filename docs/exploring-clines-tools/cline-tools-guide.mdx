---
title: "Infinity Tools Reference Guide"
---

## What Can Infinity Do?

Infinity is your AI assistant that can:
...
3. **Review Changes**
    - Infinity will show diffs before making changes
...
For the most up-to-date implementation details, you can view the full source code in the [Infinity repository](https://github.com/infinity/infinity/blob/main/src/core/Infinity.ts).

Infinity has access to the following tools for various tasks:
...
3. **MCP Tools**
    ...
    - Users can create custom MCP tools that Infinity can then access
    - Example: Create a weather API tool that Infinity can use to fetch forecasts
...
-   [Join the Discord community](https://discord.gg/infinity)
-   Check the documentation
-   Provide feedback to improve Infinity
