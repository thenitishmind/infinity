---
title: "Task Management in Infinity"
description: "Learn how to effectively manage your task history, use favorites, and organize your work in Infinity."
---

# Task Management

As you use Infinity, you'll accumulate many tasks over time. The task management system helps you organize, filter, search, and clean up your task history to keep your workspace efficient.

## Accessing Task History

You can access your task history by:

1. Clicking on the "History" button in the Infinity sidebar
2. Using the command palette to search for "Infinity: Show Task History"
...
-   **Open**: Click on a task to reopen it in the Infinity chat
...
Task management helps you maintain an organized workflow when using Infinity, allowing you to quickly find past conversations, preserve important work, and keep your history clean and efficient.
