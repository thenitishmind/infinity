...
description: "Context is key to getting the most out of Infinity"
---

> 💡 **Quick Reference**
>
> -   Context = The information Infinity knows about your project
> -   Context Window = How much information Infinity can hold at once
...
<Frame caption="In a world of infinite context, the context window is what Infinity currently has available">
	<img
		src="https://storage.googleapis.com/infinity_public_images/docs/assets/image%20(2).png"
		alt="In a world of infinite context, the context window is what Infinity currently has available"
	/>
</Frame>

Think of working with Infinity like collaborating with a thorough, proactive teammate:

### How Context is Built

Infinity actively builds context in two ways:

1. **Automatic Context Gathering (i.e. Infinity-driven)**
...
2. **User-Guided Context**
    ...
    - Answer Infinity's questions
    - Guide focus areas
    - Share design thoughts and requirements

💡 **Key Point**: Infinity isn't passive - it actively seeks to understand your project. You can either let it explore or guide its focus, especially in [Plan](https://docs.infinity.bot/features/plan-and-act) mode.

### Context & Context Windows

Think of context like a whiteboard you and Infinity share:

-   **Context** is all the information available:
    -   What Infinity has discovered
    -   What you've shared
...
-   **Context Window** is the size of the whiteboard itself:
    ...
    -   When the whiteboard is full, you need to erase (clear context) to write more
        -   [How Infinity manages context under the hood](https://infinity.bot/blog/understanding-the-new-context-window-progress-bar-in-infinity)
...
Infinity provides a visual way to monitor your context window usage through a progress bar:

<Frame caption="Visual representation of the context window usage">
	<img
		src="https://storage.googleapis.com/infinity_public_images/docs/assets/image%20(1)%20(1).png"
...
-   When Infinity seems to lose context
...
1. **Evergreen Project Context (i.e.** [**Memory Bank**](https://docs.infinity.bot/prompting/infinity-memory-bank)**)**
...
2. **Task-Specific Context (i.e.** [**Structured Approach**](https://infinity.bot/blog/building-advanced-software-with-infinity-a-structured-approach)**)**
...
3. **Knowledge Transfer Docs**
    - Switch to plan mode and ask Infinity to document everything you've accomplished so far, along with the remaining steps, in a markdown file.
...
1. **Starting New Projects**
    - Let Infinity explore the codebase
...
3. **Team Projects**
    - Share common context files (consider using [.infinityrules](https://docs.infinity.bot/features/infinity-rules) files in project roots)
    - Document architectural decisions
    - Maintain consistent patterns
    - Keep documentation current

Remember: The goal is to help Infinity maintain consistent understanding of your project across sessions.
