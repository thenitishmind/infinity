...
description: "Welcome to Infinity, your AI-powered coding companion! This guide will help you quickly set up your development environment and begin your coding journey with ease."
---

> 💡 **Tip:** If you're completely new to coding, take your time with each step. There's no rush — Infinity is here to guide you!
...
Create a dedicated folder named `Infinity` in your Documents folder for all your coding projects:

-   **macOS:** `/Users/[your-username]/Documents/Infinity`
-   **Windows:** `C:\Users\[your-username]\Documents\Infinity`

Inside your `Infinity` folder, structure projects clearly:

-   `Documents/Infinity/workout-app` _(e.g., for a fitness tracking app)_
-   `Documents/Infinity/portfolio-website` _(e.g., to showcase your work)_

> 💡 **Tip:** Keeping your projects organized from the start will save you time and confusion later!

#### 3. **Install the Infinity VS Code Extension**

Enhance your coding workflow by installing the Infinity extension directly within VS Code:

-   Get Started with Infinity Extension Tutorial
...
👉 [<u>Follow our detailed guide on Installing Essential Development Tools with step-by-step help from Infinity.</u>](https://docs.infinity.bot/getting-started/installing-dev-essentials#installing-dev-essentials)
...
🎉 You're all set! Dive in and start coding smarter and faster with **Infinity**.
