...
## Running Local Models with Infinity: What You Need to Know 🤖

Infinity is a powerful AI coding assistant that uses tool-calling to help you write, analyze, and modify code. While running models locally can save on API costs, there's an important trade-off: local models are significantly less reliable at using these essential tools.
...
<Frame>
	<img
		src="https://storage.googleapis.com/infinity_public_images/docs/assets/image%20(4).png"
...
When you run a local model with Infinity:
...
-   **"No connection could be made because the target machine actively refused it":** This usually means that the Ollama or LM Studio server isn't running, or is running on a different port/address than Infinity is configured to use. Double-check the Base URL address in your API Provider settings.
-   **"Infinity is having trouble...":** Increase your model's context length to its maximum size.
...
Local model capabilities are improving, but they're not yet a complete replacement for cloud services, especially for Infinity's tool-based functionality. Consider your specific needs and hardware capabilities carefully before committing to a local-only approach.

### Need Help? 🤝

-   Join our [Discord](https://discord.gg/infinity) community and [r/infinity](https://www.reddit.com/r/Infinity/)
