...
Utilizing MCP servers will increase your token usage. Infinity offers the ability to restrict or disable MCP server functionality as desired.

1. Click the "MCP Servers" icon in the top navigation bar of the Infinity extension.
2. Select the "Installed" tab, and then Click the "Advanced MCP Settings" link at the bottom of that pane.
3. Infinity will open a new settings window. find `Infinity>Mcp:Mode` and make your selection from the dropdown menu.

<Frame>
	<img
		src="https://storage.googleapis.com/infinity_public_images/docs/assets/MCP-settings-edit%20(1).png"
...
<Frame>
	<img
		src="https://storage.googleapis.com/infinity_public_images/docs/assets/MCP-settings-individual.png"
...
Settings for all installed MCP servers are located in the `infinity_mcp_settings.json` file:

1. Click the MCP Servers icon at the top navigation bar of the Infinity pane.
...
_Example of MCP Server config in Infinity (STDIO Transport)_
...
After configuring an MCP server, Infinity will automatically detect available tools and resources. To use them:

1. Type your request in Infinity's conversation window
2. Infinity will identify when an MCP tool can help with your task
