---
title: "MCP Overview"
description: "Learn about Model Context Protocol (MCP) servers, their capabilities, and how Infinity can help build and use them. MCP standardizes how applications provide context to LLMs, acting like a USB-C port for AI applications."
---
...
<Frame>
	<img
		src="https://storage.googleapis.com/infinity_public_images/docs/assets/mcp-diagram.png"
...
Infinity does not come with any pre-installed MCP servers. You'll need to find and install them separately.
...
-   **Infinity Marketplace:** Install one from Infinity's [MCP Marketplace](/mcp/mcp-marketplace)
-   **Ask Infinity:** You can ask Infinity to help you find or create MCP servers
...
Infinity simplifies the building and use of MCP servers through its AI capabilities.

### Building MCP Servers

-   **Natural language understanding:** Instruct Infinity in natural language to build an MCP server by describing its functionalities. Infinity will interpret your instructions and generate the necessary code.
-   **Cloning and building servers:** Infinity can clone existing MCP server repositories from GitHub and build them automatically.
-   **Configuration and dependency management:** Infinity handles configuration files, environment variables, and dependencies.
-   **Troubleshooting and debugging:** Infinity helps identify and resolve errors during development.

### Using MCP Servers

-   **Tool execution:** Infinity seamlessly integrates with MCP servers, allowing you to execute their defined tools.
-   **Context-aware interactions:** Infinity can intelligently suggest using relevant tools based on conversation context.
-   **Dynamic integrations:** Combine multiple MCP server capabilities for complex tasks. For example, Infinity could use a GitHub server to get data and a Notion server to create a formatted report.
