---
title: "LiteLLM & Infinity (using Codestral)"
description: "Learn how to set up and run LiteLLM with Infinity using the Codestral model. This guide covers Docker setup, configuration, and integration with Infinity."
---

### Using LiteLLM with Infinity

This guide demonstrates how to run a demo for LiteLLM starting with the Codestral model for use with Infinity.
...
2. **Setup Infinity**
    ...
    Once the LiteLLM server is up and running you can set it up in Infinity:
...
-   [Infinity Discord Community](https://discord.gg/infinity)
