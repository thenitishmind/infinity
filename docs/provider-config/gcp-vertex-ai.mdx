---
title: "GCP Vertex AI"
description: "Configure GCP Vertex AI with Infinity to access leading generative AI models like Claude 3.5 Sonnet v2. This guide covers GCP environment setup, authentication, and secure integration for enterprise teams."
---
...
-   **Install the Infinity Extension:**
    -   Open VS Code
    -   Navigate to the Extensions Marketplace (Ctrl+Shift+X or Cmd+Shift+X)
    -   Search for **Infinity** and install the extension

<Frame>
	<img
		src="https://storage.googleapis.com/infinity_public_images/docs/assets/infinity-extension-arrow.png"
		alt="Infinity extension in VS Code"
	/>
</Frame>

#### 3.2 Configure Infinity Settings

-   **Open Infinity Settings:**\
    Click the settings ⚙️ icon within the Infinity extension
-   **Set API Provider:**\
...
3. **Restart VS Code:**\
   Ensure VS Code is restarted so that the Infinity extension picks up the new credentials
...
4. **Set the Environment Variable:**
    ...
    - This instructs Google Cloud client libraries (and Infinity) to use this key
...
By following these steps, your enterprise team can securely integrate GCP Vertex AI with the Infinity VS Code extension to harness the power of **Claude 3.5 Sonnet v2**:
...
-   **Configure Infinity in VS Code:**\
    Install Infinity, enter your project ID, select the appropriate region, and choose the model
...
_This guide will be updated as GCP Vertex AI and Infinity evolve. Always refer to the latest documentation for current practices._
