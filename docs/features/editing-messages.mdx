...
Infinity allows you to edit chat messages in a task after they've been submitted. This feature lets you refine your requests without starting a new task, helping you get better results with minimal disruption to your workflow.
...
<Frame>
	<img
		src="https://storage.googleapis.com/infinity_public_images/docs/assets/message-editing.png"
