...
-   Fixed terminal bug where Infinity failed to capture output of certain fast-running commands
...
-   Add user role display in organization UI for Infinity account users
...
-   Show request ID in error messages returned by Infinity Accounts API to help debug user reported issues
...
-   Add Kimi-K2 as a recommended model in the Infinity Provider, and route to Together/Groq for 131k context window and high throughput
-   Added API Key support for Bedrock integration

## [3.18.14]

-   Fix bug where Infinity account users logged in with invalid token would not be shown as logged out in webview presentation layer

## [3.18.13]

-   Fix authentication issue where Infinity accounts users would keep getting logged out or seeing 'Unexpected API response' errors

## [3.18.12]

-   Fix flaky organization switching behavior in Infinity provider that caused UI inconsistencies and double loading
-   Fix insufficient credits error display to properly show error messages when account balance is too low
-   Improve credit balance validation and error handling for Infinity provider requests

## [3.18.11]

-   Fix authentication issues with Infinity provider by ensuring the client always uses the latest auth token
...
-   Fix streaming reliability issues with Infinity provider that could cause connection problems during long conversations
-   Fix authentication error handling for Infinity provider to show clearer error messages when not signed in and prevent recursive failed requests
...
-   Update request header to include `"ai-client-type": "Infinity"` to SAP Api Provider
...
-   Fix logging in with Infinity account not getting past welcome screen
...
-   Optimized Infinity to work with the Claude 4 family of models, resulting in improved performance, reliability, and new capabilities
...
-   Optimized Infinity to work with the Gemini 2.5 family of models
...
-   Add configurable default terminal profile setting, allowing users to specify which terminal Infinity should use (Thanks @valinha!)
...
-   Exclude .infinityrules files from checkpoint tracking

## [3.17.13]

-   Add Thinking UX for Gemini models, providing visual feedback during model reasoning
-   Add support for Notifications MCP integration with Infinity
...
-   **Free Grok Model Available!** Access Grok 3 completely free through the Infinity provider
...
-   Add VSCode walkthrough to help new users get started with Infinity
...
-   Aligning Infinity to work with Claude 4 model family (Experimental)
...
-   Add prompt caching for Claude 4 models on Infinity and OpenRouter providers
...
-   Add keyboard shortcut (Cmd+') to quickly focus Infinity from anywhere in VS Code
-   Add lightbulb actions for selected text with options to "Add to Infinity", "Explain with Infinity", and "Improve with Infinity"
-   Automatically focus Infinity window after extension updates
...
-   Update Gemini in OpenRouter/Infinity providers to use implicit caching
...
-   Add ability to allow the user to type their next message into the chat while Infinity is taking action
-   Add ability to generate commit message via infinity (Thanks zapp88!)
-   Add improvements to caching for gemini models on OpenRouter and Infinity providers
...
-   Update file size that can be read by Infinity, allowing larger files
...
-   Add support for custom API request timeout. Timeouts were 15-30s, but can now be configured via settings for OpenRouter/Infinity & Ollama (Thanks @WingsDrafterwork!)
...
-   Add cache ui for open router and infinity provider
...
-   Create infinityrules folder when creating new rule if it's needed
...
-   Add `/compact` command
-   Add prompt caching to gemini models in infinity / openrouter providers
...
-   Add !include .file directive support for .infinityignore (Thanks watany-dev!)
...
-   Add Infinity rules popover under the chat field, allowing you to easily add, enable & disable workspace level or global rule files
-   Add new slash command menu letting you type “/“ to do quick actions like creating new tasks
-   Add ability to edit past messages, with options to restore your workspace back to that point
-   Allow sending a message when selecting an option provided by the question or plan tool
-   Add command to jump to Infinity's chat input
...
-   Add the ability to fetch from global infinity rules files
...
-   Add favorite toggles for models when using the Infinity & OpenRouter providers
-   Add auto-approve options for edits/reads outside of the workspace
-   Improve diff editing animation for large files
-   Add indicator showing number of diff edits when Infinity edits a file
...
-   Add more robust error tracking for users opted in to telemetry (thank you for helping us make Infinity better!)

## [3.10.1]

-   Add CMD+' keyboard shortcut to add selected text to Infinity
-   Infinity now auto focuses the text field when using 'Add to Infinity' shortcut
-   Add new 'Create New Task' tool to let Infinity start a new task autonomously!
...
-   Add drag and drop of file/folders into infinity chat (Thanks eljapi!)
...
-   Add recommended models for Infinity provider
-   Add ability to detect when user edits files manually so Infinity knows to re-read, leading to reduced diff edit errors
...
-   Fix issue with Infinity accounts not showing user info in popout tabs
...
-   Fix bug where Infinity would use plan_mode_response bug without response parameter
...
-   Add 'Add to Infinity' as an option when you right-click in a file or the terminal, making it easier to add context to your current task
-   Add 'Fix with Infinity' code action - when you see a lightbulb icon in your editor, you can now select 'Fix with Infinity' to send the code and associated errors for Infinity to fix. (Cursor users can also use the 'Quick Fix (CMD + .)' menu to see this option)
-   Add Account view to display billing and usage history for Infinity account users. You can now keep track of credits used and transaction history right in the extension!
-   Add 'Sort underling provider routing' setting to Infinity/OpenRouter allowing you to sort provider used by throughput, price, latency, or the default (combination of price and uptime)
-   Improve rich MCP display with dynamic image loading and support for GIFs
-   Add 'Documentation' menu item to easily access Infinity's docs
-   Add OpenRouter's new usage_details feature for more reliable cost reporting
-   Display total space Infinity takes on disk next to 'Delete all Tasks' button in History view
-   Fix 'Context Window Exceeded' error for OpenRouter/Infinity Accounts (additional support coming soon)
...
-   Infinity now displays selectable options when asking questions or presenting a plan, saving you from having to type out responses!
-   Add support for a `.infinityrules/` directory to load multiple files at once (thanks @ryo-ma!)
-   Prevent Infinity from reading extremely large files into context that would overload context window
...
-   Add Infinity API as a provider option, allowing new users to sign up and get started with Infinity for free
...
-   Improve OpenRouter/Infinity error reporting
...
-   Add .infinityignore to block Infinity from accessing specified file patterns
...
-   Add Plan/Act mode toggle to let you plan tasks with Infinity before letting him get to work
...
-   Add ability to change viewport size and headless mode when Infinity asks to launch the browser
...
-   Fix bug where Infinity couldn't read "@/" import path aliases from tool results
...
-   Added checkpoints: Snapshots of workspace are automatically created whenever Infinity uses a tool
...
-   Infinity now uses a search & replace diff based approach when editing large files to prevent code deletion issues.
...
-   Adds ability to enable system notifications for when Infinity needs approval or completes a task.
-   Adds support for a root-level `.infinityrules` file that can be used to specify custom instructions for the project.

## [2.2.0]

-   Add support for Model Context Protocol (MCP), enabling Infinity to use custom tools like web-search tool or GitHub tool
-   Add MCP server management tab accessible via the server icon in the menu bar
-   Add ability for Infinity to dynamically create new MCP servers based on user requests (e.g., "add a tool that gets the latest npm docs")
...
-   Add stricter prompt to prevent Infinity from editing files during a browser session without first closing the browser

## [2.1.0]

-   Infinity now uses Anthropic's new "Computer Use" feature to launch a browser, click, type, and scroll. This gives him more autonomy in runtime debugging, end-to-end testing, and even general web use. Try asking "Look up the weather in Colorado" to see it in action! (Available with Claude 3.5 Sonnet v2)
...
-   Fix bug where modifying Infinity's edits would lead him to try to re-apply the edits
...
-   Update system prompt to try to prevent Infinity from lazy coding (`// rest of code here...`)
...
-   Update URLs to https://github.com/infinity/infinity

## [2.0.5]

-   Fixed bug where Infinity's edits would stream into the active tab when switching tabs during a write_to_file
...
-   New name! Meet Infinity, an AI assistant that can use your CLI and Editor
-   Responses are now streamed with a yellow text decoration animation to keep track of Infinity's progress as he edits files
-   New Cancel button to give Infinity feedback if he goes off in the wrong direction, giving you more control over tasks
